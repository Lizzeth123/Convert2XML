...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mml="http://www.w3.org/1998/Math/MathML" version="1.0" exclude-result-prefixes="xlink mml">
    ...
    <html>
      ...
      <body>
	    <div class="wrapperMenu">
			<div id="izquierda">
				<h3>
					<a id="descargarXML" class="link" style="background: #FFF;">
						<img class="icon icons8-Download-From-Cloud-Filled" src="data:image/png;base64," width="48" height="48"/>
					</a>
				</h3>  
			</div>
			<div id="derecha">
		...
		a.link { color: #ff9900; background: #fff4a3; text-decoration: none; }
		a.link:hover { color: #ffcc66 }
		h1 { color: #7c795d; font-family: 'Trocchi', serif; font-size: 30px; font-weight: normal; line-height: 48px; }
		h2 { color: #7c795d; font-family: 'Source Sans Pro', sans-serif; font-size: 22px; font-weight: 400; line-height: 25px; text-align : center;  }
  ...
  <xsl:template match="counts" mode="metadata">
    ...
    <xsl:call-template name="metadata-area">
      <xsl:with-param name="label">Totales</xsl:with-param>
      <xsl:with-param name="contents">
        <xsl:apply-templates mode="metadata"/>
      </xsl:with-param>
    </xsl:call-template>
  ...
  <xsl:template match="boxed-text | chem-struct-wrap | fig |                        table-wrap | chem-struct-wrapper">
    ...
    <div class="{$gi} panel">
      <xsl:if test="not(@position != 'float')">
        ...
        <xsl:attribute name="style">border: thin solid #EEE</xsl:attribute>
      </xsl:if>
      <xsl:call-template name="named-anchor"/>
      <xsl:apply-templates select="." mode="label"/>
      <xsl:apply-templates/>
  ...
  <xsl:template match="aff/label | corresp/label | chem-struct/label |     element-citation/label | mixed-citation/label | citation/label">
  ...
  <xsl:template match="email">
    <xsl:text> </xsl:text><a href="mailto:{.}">
      <xsl:apply-templates/>
    </a>
  </xsl:template>
